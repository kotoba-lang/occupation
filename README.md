...
2641, 2651, 2652, 2654, 1219, 1223, 1330 and 1341 are `:maturity
:implemented` (real reference actors exist); the other 54 are `:maturity
...
going forward" direction, 11 of the 34 `:implemented` entries — 6130,
8160, 2166, 2641, 2651, 2652, 2654, 1219, 1223, 1330 and 1341 — are on the full itonami Actor
