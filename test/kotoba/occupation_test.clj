...
(deftest maturity-tier
  ...
  (testing "maturity-summary counts tiers"
    (let [m (occupation/maturity-summary)]
      ...
      ;; Additional concurrent promotions: 250 -> 247 / 179 -> 182.
      ;; 3132 (Incinerator and Water Treatment Plant Operators) promoted to :implemented: 247 -> 246 / 182 -> 183.
      (is (= 246 (:spec m)))
      (is (= 183 (:implemented m))))))
