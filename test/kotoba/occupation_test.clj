...
(deftest maturity-tier
  ...
  (testing "maturity-summary counts tiers"
    (let [m (occupation/maturity-summary)]
      ...
      (is (= 7 (:blueprint m)))
      ;; 2162 (Landscape Architects), 2163 (Product and Garment Designers), 2146 (Mining Engineers),
      ;; and the rest of an 8-item batch (2132/2133/2143/2164/3114/3132) promoted to
      ;; :implemented: 254 -> 244 / 175 -> 185.
      (is (= 244 (:spec m)))
